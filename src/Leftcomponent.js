function LeftComponent() {
  return (
    <div className=" shadow-2xl border-1  border-black mx-2 rounded-xl top-[140px] bg-white h-[13%] w-[94%] absolute">
      <img src="blockchainlogo.jpg" alt="logo" className="rounded-t-xl h-29" />
